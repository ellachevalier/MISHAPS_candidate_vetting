...
def run_batman(p0_guess, period, ecc, w, rldc_r, rldc_z, time_transits_r, time_transits_z, mag_transits_r, mag_transits_z, err_transits_r, err_transits_z, title='Transit model', folded=False, t0_1=None, flag=True):
...
#         #plt.show()
    ...
    if folded==True:
        ...
        data_r_folded, data_z_folded = folded_lightcurve(data_r_all, data_z_all, period, t0_1, show_plot=False) #ans_r=ans_r, ans_z=ans_z, initial_guess_r=initial_guess_r, initial_guess_z=initial_guess_z)
        plt.figure()
        plt.plot(data_r_folded['phases_r'], data_r_folded['mag_r'],'o', color='blue', label='data r', markersize=1.)
        plt.plot(data_z_folded['phases_z'], data_z_folded['mag_z'],'o', color='red', label='data z', markersize=1.)
    ...
    return param, cov_err, err_tot_adj, results, ans_r, ans_z
